...
for rate in $(seq 0.02 0.02 0.40); do
    ...
    DESTINATION="/home/deepeshsahu/Desktop/reproduced-results/SyntheticRS/8_8/UniformRandom/8HT/${FILENAME}"
    ...
    # DESTINATION="/home/deepeshsahu/Desktop/reproduced-results/SyntheticRS/8_8/BitComplement/8HT/${FILENAME}"
