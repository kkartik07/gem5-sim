...
for rate in $(seq 0.02 0.02 0.40); do
    ...
    # DESTINATION="/home/deepeshsahu/Desktop/reproduced-results/SyntheticRS/4_4/UniformRandom/4HT/${FILENAME}"
    ...
    # DESTINATION="/home/deepeshsahu/Desktop/reproduced-results/SyntheticRS/4_4/BitComplement/4HT/${FILENAME}"
